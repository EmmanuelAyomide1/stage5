"""
Django settings for FrontedHNG project.
...
SECRET_KEY = 'django-insecure-b!p%w*u@8b_!*r093%&u0x(1zuxw&fzssz%$)6u_$ptvn^^#@%'
...
WSGI_APPLICATION = 'FrontedHNG.wsgi.application'
